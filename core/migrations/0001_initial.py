# Generated by Django 2.2.13 on 2021-11-03 07:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('Mirrorless Cameras', 'Mirrorless Cameras'), ('DSLR', 'DSLR'), ('Bridge', 'Bridge'), ('Digital Cameras', 'Digital Cameras')], default='uncategorized', max_length=255)),
                ('label', models.CharField(choices=[('P', 'primary'), ('W', 'warning'), ('D', 'danger')], max_length=1)),
                ('slug', models.SlugField()),
                ('description', models.CharField(max_length=5000)),
                ('additional_description', models.CharField(max_length=10000)),
